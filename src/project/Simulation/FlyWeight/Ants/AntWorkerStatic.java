...
public class AntWorkerStatic extends Ant {
    ...
    private Set<AntWorkerDynamic> antWorksDyn = new HashSet<>();

    public AntWorkerStatic(Land ld, AntQueen antQ, Food candy) {
    ...
    private void locTo(Point2D pos) {
        ...
        // Point2D p = (new Point2D(vecX, vecY)).normalize();
        Random r = new Random();
