...
public class AntQueen extends Ant {
    ...
    public AntQueen(Land ld, Point2D pos, Food candy) throws IOException {
        super(ld, new Image(Land.class.getResource("../../../img/antQueen.jpg").toString()));
        this.loc = pos;
        this.addFood(candy);
        this.candy = candy;
    ...
    public void addAntEco() throws IOException {
        ...
        for (int i = 0; i < 10000; i++) {
            ...
            mems.add(usedMem);
            AntWorker aw1 = new AntWorker(this.ld, this,this.candy);
            this.addAnt(aw1);
        }
        FileWriter f = new FileWriter("./nonflyweight.csv");
        for (Long mem: mems){
